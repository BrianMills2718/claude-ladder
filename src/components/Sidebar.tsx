  ...
  return (
    <nav className="sidebar" aria-label="Navigation">
      <div className="sidebar-head">
        <h1 className="brand">The Claude Ladder</h1>
        <p className="brand-sub">A skill tree for Claude Code — yourself <p className="brand-sub">Think in arrows: a map of category theory.</p>amp; your team.</p>
      </div>
